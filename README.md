...
# 🛍️ Shopify Review Widget Challenge

**Welcome to Profitonium Apps!**  
This coding challenge is designed to assess your foundational skills in **React, Node.js, and Shopify integration**. Don’t worry—it’s meant to be a learning experience! We value effort and problem-solving over perfection. 💡
...
✅ **Top 10% of applicants** who balance technical skill with creativity.  
✅ **Self-starters** who thrive in fast-paced startup environments.  

---

## ❓ Why We’re Asking for This  

At **Profitomium Apps**, we create tools that empower Shopify merchants to grow. This challenge mirrors real-world tasks you’d tackle as a Full-Stack Developer here. Here’s why we’re asking you to build this:  

1. **Skill Assessment**:  
   - 🛠️ **Core Technologies**: Test your ability to work with **React, Liquid, and Shopify theme app extensions**—key tools we use daily.  
   - 🧩 **Problem-Solving**: Show us how you debug integrations or optimize user experiences.  

2. **Learning Opportunity**:  
   - New to Liquid or theme extensions? This is a chance to dive into new ecosystem—a valuable skill for your career.  

4. **Cultural Fit**:  
   - We value creativity, attention to detail, and grit. How you approach this task tells us how you’ll tackle challenges at Profitomium.  

**Note**: We don’t expect perfection! Documenting your thought process and effort matters more than flawless code.  
...
## 🎯 Objective  
Build a **Product Review Widget** for Shopify stores with these core features:  
1. **Display Reviews**: Show existing reviews (name, rating, comment).  
2. **Submit Reviews**: Allow users to add new reviews via a form.  
3. **Basic Styling**: Ensure the widget looks clean on desktop and mobile.  

**Bonus (Optional)**:  
- Filter reviews by star rating (e.g., show only 5-star reviews).  
- Add animations for form submissions.  
...
1. **Clone this repository**:  
   ```bash
   git clone https://github.com/profitonium-apps/shopify-review-app-coding-challenge.git
...
- Follow Shopify’s prompts to install the app on a test store (create one [here](https://partners.shopify.com/signup) if needed).
...
### Core Requirements  
- [ ] **Frontend (React)**:  
  - Create a `ReviewWidget.tsx` component to display reviews in the admin side. (Not in the storefront. Because otherwise it would take more time to implement)
  - Build a form with fields for *name*, *rating* (1-5 stars), and *comment*. (This form should be shown in the storefront in the product page and in the admin side we will see all the latest reviews in ReviewWidget.tsx)
  - Use CSS to style the widget (e.g., `ReviewWidget.css`).  

- [ ] **Backend (Node.js/Express)**:  
  - Create a `POST /reviews` API endpoint to handle form submissions.  
  - Store reviews in a JSON file (no database setup required).

- [ ] **Shopify Integration (Liquid)**:  
  - Embed the widget into a Shopify product page using [Liquid templating](https://shopify.dev/docs/api/liquid).  

### Bonus Tasks (Optional)  
- [ ] Add a filter to sort reviews by rating.  
- [ ] Implement CSS animations for form submissions.  

---

## 🛠️ Resources  
- **Liquid Basics**: [Shopify Liquid Documentation](https://shopify.dev/docs/api/liquid)  
- **React Forms**: [React Form Handling Guide](https://react.dev/reference/react/useState)  
- **Remix**: [Remix Documentation](https://remix.run/)
...
1. **GitHub Repository**:  
   ...
   - Include a `README.md` explaining:  
     ...
     - Screenshots of your widget.  

2. **Live Demo**: Host your app on free platforms like Heroku or Fly.io.  

3. **Deadline**: Submit by **[1st February 2025]** via email to [hello@profitoniumapps.com].  
...
|------------------|--------|-------------------------------------------------------------------------|
| **Functionality** | 50%    | Core features work (display/submit reviews).                           |
| **Code Quality**  | 30%    | Readable, organized code with comments.                                |
| **Effort**        | 20%    | Bonus tasks, problem-solving, or creative solutions.                   |

---

## 🙋 Need Help?  
Stuck? Message me on LinkedIn: [https://www.linkedin.com/in/abhinavpanse/](https://www.linkedin.com/in/abhinavpanse/)
- Details: Describe your issue + screenshots (if possible).  

---

**Good luck! We’re excited to see your creativity and passion for learning.**  
*Team Profitonium Apps* 🚀
